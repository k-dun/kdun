  ...
  return (
    <>
      <section id="about" className="w-[90svw] md:w-[70vw] lg:w-full bg-[#FCFAFF] mx-auto lg:px-36 flex flex-col justify-center pt-[14vh] pb-4">
        ...
        <h4 className="text-lg lg:w-[70vw]">
          ...
          <p className="font-normal pb-7">
            ...
            implementing agile methodology, to code reviews and solving those inevitable merging conflicts.
          </p>
          <p className="font-semibold mb-5">
            I am now ready to start my career in tech. I feel I have barely scratched the surface yet and I am keen 
            to build on my experiences and keep learning and growing as a software developer.
          </p>
        </h4>
      </section>
    </>
