    ...
    <>
      <section className="min-h-[88svh] w-[100vw] lg:w-full lg:px-32 flex flex-col lg:flex-row-reverse pt-[12svh] items-center bg-[#FCFAFF]">
        ...
        <div className="w-[90svw] md:w-[70vw] lg:w-[50vw] pt-12 md:pt-16 lg:pt-18 flex flex-col items-center justify-center">
          ...
          <h1 className="w-[90svw] md:w-[70vw] lg:w-[40vw] text-lg md:text-xl lg:text-2xl mt-8 lg:mt-10"><span className="text-[#FF8080]">00</span> My name is 
            Konrad and I am a frontend engineer based in London. I am passionate about UI/UX, web 
            design, startups and all things tech.</h1>
          <div className="w-[90svw] md:w-[70vw] lg:w-[40vw] flex flex-row pt-4 md:pt-6 lg:mt-8">
            <Link href="/#about">
              <button className="w-[42svw] md:w-[26vw] lg:w-[16vw] font-semibold text-[#202020] bg-[#FCFAFF] text-base md:text-lg lg:text-xl px-5 lg:px-6 py-3 lg:py-4 rounded-md border lg:border-2 border-[#202020] flex flex-row justify-center mr-3">
                <span className="text-[#FF8080] mr-2">01</span>Projects
              </button>
            </Link>
            <Link href="/Konrad_Dunski_CV.pdf" target="_blank">
              <button className="w-[42svw] md:w-[26vw] lg:w-[16vw] font-semibold text-[#202020] bg-[#FCFAFF] text-base md:text-lg lg:text-xl px-5 lg:px-6 py-3 lg:py-4 rounded-md border lg:border-2 border-[#FF8080] mr-2 flex flex-row justify-center">
