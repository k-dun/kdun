      ...
      <section className="min-h-[88svh] w-[100vw] lg:w-full lg:px-32 flex flex-col lg:flex-row-reverse pt-[12svh] items-center bg-[#FCFAFF]">
        ...
        <div className="w-[90svw] md:w-[70vw] lg:w-[50vw] pt-12 md:pt-16 lg:pt-18 flex flex-col items-center justify-center">
          ...
          <div className="w-[90svw] md:w-[70vw] lg:w-[40vw] flex flex-row pt-4 md:pt-6">
            <Link href="/#about">
              <button className="w-[42svw] md:w-[26vw] lg:w-[16vw] font-semibold text-[#202020] bg-[#FCFAFF] text-base md:text-lg px-5 py-3 rounded-md border lg:border-2 border-[#202020] flex flex-row justify-center mr-3">
                <span className="text-[#FF8080] mr-2">01</span>Projects
              </button>
            </Link>
            <Link href="/Konrad_Dunski_CV.pdf" target="_blank">
              <button className="w-[42svw] md:w-[26vw] lg:w-[16vw] font-semibold text-[#202020] bg-[#FCFAFF] text-base md:text-lg px-5 py-3 rounded-md border lg:border-2 border-[#FF8080] mr-2 flex flex-row justify-center">
