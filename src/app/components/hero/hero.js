      ...
      <section className="min-h-[88svh] w-full flex flex-col pt-[12svh] items-center bg-[#FCFAFF]">
        ...
        <div className="w-[90svw] md:w-[75vw] pt-12 md:pt-16 flex flex-col items-center justify-center">
          ...
          <div className="w-[90svw] md:w-[75vw] flex flex-row pt-4 md:pt-6">
            <Link href="/#about">
              <button className="w-[42svw] md:w-[30vw] font-semibold text-[#202020] bg-[#FCFAFF] text-base md:text-lg px-5 py-3 rounded-md border border-[#202020] flex flex-row justify-center mr-3">
                <span className="text-[#FF8080] mr-2">01</span>Projects
              </button>
            </Link>
            <Link href="/Konrad_Dunski_CV.pdf" target="_blank">
              <button className="w-[42svw] md:w-[30vw] font-semibold text-[#202020] bg-[#FCFAFF] text-base md:text-lg px-5 py-3 rounded-md border border-[#FF8080] mr-2 flex flex-row justify-center">
