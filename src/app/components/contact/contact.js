...
export default function Contact() {
  ...
  return (
    <>
      <section id="contact" className="w-[90svw] md:w-[70vw] lg:w-[100vw] bg-[#FCFAFF] mx-auto flex flex-col justify-center mt-32 pb-4">
        <h3 className="text-xl md:text-2xl mb-16 lg:ml-32 font-semibold"><span className="text-[#FF8080]">04</span> CONTACT</h3>
