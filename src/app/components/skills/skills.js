export default function Skills() {
  ...
  return (
    <>
      <section id="skills" className="w-[90svw] md:w-[70vw] lg:w-[100vw] bg-[#FCFAFF] flex flex-col lg:flex-row justify-center lg:justify-start lg:ml-32 pt-[12svh] pb-4">
        <div className="lg:flex lg:flex-col lg:w-[40%] lg:mr-16">
        ...
        <div className="lg:flex lg:flex-col lg:w-[40%]">
          <h3 className="text-xl md:text-2xl my-12 lg:mb-12 lg:mt-0 font-semibold"><span className="text-[#FF8080]">02.2</span> SOFT SKILLS</h3>
