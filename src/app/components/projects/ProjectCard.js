      ...
      <div className="lg:flex lg:flex-col lg:w-[60vw]">
        ...
        <div className="w-full flex flex-row py-8 pr-8 pl-3 md:pl-0 lg:ml-10 justify-around md:justify-start">
          <Link href={project.codeUrl} target="_blank">
            <button className="w-[38svw] md:w-[26vw] lg:w-[12vw] font-semibold text-[#202020] bg-[#FCFAFF] text-base md:text-lg px-5 lg:px-6 py-3 lg:py-4 rounded-md border border-[#202020] justify-center mr-2 md:mr-4">Code</button>
          </Link>
          <Link href={project.liveUrl} target="_blank">
            <button className="w-[38svw] md:w-[26vw] lg:w-[12vw] font-semibold text-[#202020] bg-[#FCFAFF] text-base md:text-lg px-5 lg:px-6 py-3 lg:py-4 rounded-md border border-[#FF8080] flex flex-row justify-center">Link</button>
          </Link>
        </div>
      </div>
