      ...
      <div className="lg:flex lg:flex-col lg:w-[40vw]">
        ...
        <p className="px-2 md:px-0 flex flex-wrap">
          {project.tech.map((tech, index) => (
            <span key={index} className="bg-[#202020] text-[#FCFAFF] text-sm md:text-base shadow-md rounded-2xl px-6 lg:px-8 py-1.5 lg:py-2 mx-1 lg:mx-0 lg:mr-2 my-1 lg:my-2 lg:flex-wrap">
              {tech}
            </span>
          ))}
        </p>
