...
export default function Projects() {
  ...
  const projects = [
    {
      ...
      imageUrl: '/gh-streaks-screenshot.png',
      codeUrl: 'https://github.com/k-dun/GH-Streak',
      liveUrl: '',
    },
    {
      title: 'Pollyglot',
      description: 'Pollyglot is a web-based translation application that allows users to translate text into French, German, or Spanish using OpenAI API',
    ...
    {
      title: 'TattooGem (work in progress)',
    ...
    {
      title: 'Studio One Bodega (work in progress)',
      description: 'Website for my local barbershop.',
      tech: ['Next.js', 'Typescript', 'React', 'TailwindCSS', 'Node.js', 'Lovable'],
      imageUrl: '/studioonebodega-screenshot.png',
      codeUrl: 'https://github.com/k-dun/mindful-hair-hub',
      liveUrl: 'https://sob-v1.vercel.app/',
    },
    {
      title: 'Hoodlums (work in progress)',
  ...
  return (
    <>
      <section id="projects" className="w-[90vw] md:w-[70vw] lg:w-full lg:px-36 lg:mx-auto bg-[#FCFAFF] mx-auto pt-[14vh] flex flex-col justify-center items-center pb-4">
